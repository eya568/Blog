                    ...
                    <div class="card mb-3">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <div class="btn-group">
                                ...
                                <button type="button" class="btn btn-sm btn-outline-secondary  fa fa-ellipsis-v"
                                    data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"></button>
                                <!-- Dropdown menu -->
                                <div class="dropdown-menu">
                                    <button class="dropdown-item deletePub" data-bs-toggle="modal"
                                        data-bs-target="#deleteModal{{ $publication->id }}"
                                        data-value="{{ $publication->id }}">Delete</button>
                        ...
                        <div class="card-footer">
                            ...
                            <div class="collapse" id="commentsCollapse{{ $publication->id }}">
                                <form id="addComment" action="/publications/{{ $publication->id }}/comments" method="POST"
                                    class="mt-2">
                                    @csrf
                                    <div class="d-flex">
                                        <input type="text" class="form-control" id="comment" name="content"
                                            placeholder="Add a comment" required style="height: 30px;">
                                        <button type="submit" class="btn btn-primary btn-sm ml-2"
                                            style="height: 30px;">Post</button>
                                    </div>
                                </form>
